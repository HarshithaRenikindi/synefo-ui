          ...
          return (
            <>
              ...
              <div className="space-y-3 h-60 overflow-auto">
                <div className="flex text-sm font-medium text-[#000000] border-b pb-2">
                ...
                {titles.length > 0 ? titles.map((title, index) => (
                  ...
                  //   <h3 className="font-medium text-sm" style={{ color: '#383874',textAlign:'left'}}>{index + 1}. {title}</h3>
                  // </div>
  ...
  return (
    <div className="p-2">
      ...
      <div className="flex flex-col md:flex-row md:gap-4 m-4">
        <div className="bg-white p-4 rounded-lg shadow-md h-96 w-full md:w-1/2">
      ...
      <div className="flex flex-col md:flex-row md:gap-4 m-4">
        <div className="bg-white p-4 rounded-lg shadow-md  h-96  w-full md:w-1/3">
