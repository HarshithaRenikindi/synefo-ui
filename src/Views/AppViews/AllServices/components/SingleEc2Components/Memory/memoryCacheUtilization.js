...
const MemoryCacheUtilization = () => {
  ...
  return (
    <div className='py-2 px-4'> {/* Set the size of the container */}
      <h2>Memory Cache Utilization</h2>
      <p>Visualize the percentage of memory used for caching</p>
      <Line data={data} options={options} />
    </div>
  );
};

export default MemoryCacheUtilization;
