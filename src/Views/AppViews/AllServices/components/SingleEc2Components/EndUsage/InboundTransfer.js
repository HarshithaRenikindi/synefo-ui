...
const InboundTransfer = () => {
  ...
  const data = {
    ...
    datasets: [{
      label: 'Volume',
      data: [10, 15, 11, 7, 10, 20, 13, 7, 13, 11, 7, 14],  // Sample CPU utilization data
      fill: false,
  ...
  return (
    <div className='w-full bg-white py-2 px-4 rounded-md '> {/* Set the size of the container */}
      <h2>Network Data Transfer (Inbound)</h2>
      <p>Inbound Network Data Transfer Volume Over the Last months</p>
