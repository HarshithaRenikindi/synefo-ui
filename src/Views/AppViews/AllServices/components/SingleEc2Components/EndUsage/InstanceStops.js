...
const InstanceStops = () => {
  ...
  const data = {
    ...
    datasets: [{
      ...
      fill: false,
      borderColor: 'rgb(56, 56, 116)',  // Color for CPU utilization line
  ...
  return (
    <div className='w-full bg-white py-2 px-4 rounded-md '> {/* Set the size of the container */}
      <h2>Instance (Stops)</h2>
      <p>Instance stops by count Over the Last months</p>
      <Line data={data} options={options} />
    </div>
  );
};

export default InstanceStops;
