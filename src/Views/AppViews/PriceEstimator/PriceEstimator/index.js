...
class PriceEstimator extends Component {
  render() {
    ...
    return (
      <div className="p-6">
        <h2 className="text-3xl font-semibold mb-10 text-start">Price Estimator</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 g:grid-cols-3 gap-10 justify-center">
