  ...
  return (
    <div className="p-2 bg-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 m-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md "> {/* Reduced card size, fixed height */}
        <h2 className="font-bold mb-4" sx={{fontFamily:'poppins'}} style={{color:'#383874'}}>Write Bandwidth (MiB/second)</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 m-4">
        <div className="bg-white p-4 rounded-lg shadow-md ">
        <h2 className="font-bold mb-4" sx={{fontFamily:'poppins'}} style={{color:'#383874'}}>Burst Balance (%)</h2>
